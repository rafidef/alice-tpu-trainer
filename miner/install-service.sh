...
[Unit]
Description=Alice Protocol Miner
...
ExecStart=/bin/bash ${ROOT_DIR}/miner/service-entry.sh
Restart=always
RestartSec=10
...
<plist version="1.0">
  <dict>
    ...
    <array>
      ...
      <string>${ROOT_DIR}/miner/service-entry.sh</string>
    </array>
    ...
    <string>${LOG_DIR}/miner-service.log</string>
